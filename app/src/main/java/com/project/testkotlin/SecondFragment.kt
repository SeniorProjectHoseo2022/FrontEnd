...
class SecondFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        list_item2.add("1. 1644-9300" + "\n 휴대폰 판매 의심 번호입니다")
        list_item2.add("2. 02-6230-9064" + "\n 휴대폰 판매 의심 번호입니다")
        list_item2.add("3. 031-927-5521" + "\n 휴대폰 판매 의심 번호입니다")
        list_item2.add("4. 02-6949-4281" + "\n 사기전화 유도 의심 번호입니다")
        list_item2.add("5. 02-6470-1728" + "\n 사기전화 유도 의심 번호입니다")
        list_item2.add("6. 070-7077-2294" + "\n 설문조사 마케팅 의심 번호입니다")
        list_item2.add("7. 02-6196-2713" + "\n 설문조사 마케팅 의심 번호입니다")
        list_item2.add("8. 032-324-3540" + "\n 중고사기 의심 번호입니다")
        list_item2.add("9. 031-605-3078" + "\n 중고사기 의심 번호입니다")
        list_item2.add("10. 041-425-7527" + "\n 악성코드 유포 의심 번호입니다")
